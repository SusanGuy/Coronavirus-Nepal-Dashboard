...
//     STATE_POPULATIONS
// } from '../../constants';
// import { formatDate, formatNumber } from '../utils/common-functions';
...
//                             let typeCount = parseInt(state[dtype !== 'deceased' ? dtype : 'deaths']);
...
//                     }, {});
//                 } else if (currentMapMeta.mapType === MAP_TYPES.STATE) {
//                     const districtWiseData = (districts[currentMap.name] || { districtData: {} }).districtData;
...
//         },
//         [ currentMap.name, currentMap.stat, currentMapMeta.mapType, districts, zones, states ]
//     );
...
//                     !(currentMapMeta.mapType === MAP_TYPES.COUNTRY && currentMap.view === MAP_VIEWS.DISTRICTS)
//                 ) {
...
//         () => stateTestData.find((obj) => obj.state === panelRegion.state && obj.totaltested !== ''),
...
//     } else {
//         hoveredRegionZone =
//             zones[hoveredRegion.state] && zones[hoveredRegion.state][hoveredRegion.district]
...
//                     {currentMapMeta.mapType === MAP_TYPES.COUNTRY ? t('state/UT') : t('district')}{' '}
//                     {t('for more details')}
//                 </h6>
//             </div>
...
//                 <h2
//                     className={`${currentMap.stat !== MAP_STATISTICS.ZONE
//                         ? mapOption !== 'confirmed' ? mapOption : ''
//                         : hoveredRegionZone}`}
//                 >
//                     {hoveredRegion.district ? t(hoveredRegion.district) : t(hoveredRegion.state)}
//                 </h2>
...
//                                 ''
//                             ) : (
//                                 formatDistance(new Date(formatDate(panelRegion.lastupdatedtime)), new Date()) +
//                                 ' ' +
//                                 t('ago')
//                             )}
//                         </h3>
...
//                 (currentMapMeta.mapType === MAP_TYPES.STATE ||
//                     (currentMapMeta.mapType === MAP_TYPES.COUNTRY && currentMap.stat !== MAP_STATISTICS.TOTAL)) ? (
//                     <h1 className={`district ${mapOption !== 'confirmed' ? mapOption : ''}`}>
//                         {hoveredRegionCount}
//                         <br />
//                         <span>
//                             {mapOption} {currentMap.stat === MAP_STATISTICS.PER_MILLION ? ` ${t('per million')}` : ''}
//                         </span>
//                     </h1>
//                 ) : null}

//                 {currentMapMeta.mapType === MAP_TYPES.STATE ? (
//                     <div className='button back-button' onClick={() => switchMapToState('Nepal')}>
//                         Back
//                     </div>
//                 ) : null}
...
//                         {t('Districts unknown for')} {currentMapData.Unknown[mapOption]} {t('people')}
//                     </h4>
//                 ) : null}
//             </div>
