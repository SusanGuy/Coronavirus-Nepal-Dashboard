        ...
        navigator.geolocation.getCurrentPosition(
            async (position) => {
                ...
                const { data } = await axios.get(
                    `https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${position.coords
                        .latitude}&longitude=${position.coords.longitude}&localityLanguage=en`
                );
    ...
    if (loading) {
        return (
            ...
            >
                ...
                <rect x={700 / 2 + 70} y='18' rx='100' ry='100' width='15' height='15' />
            ...
            {!hospitals && (
                <React.Fragment>
                    <button
                        ...
                        style={{ animationDelay: '0.6s', marginTop: '50px' }}
                        onClick={() => {
                            getLocation();
                        }}
                    >
                                ...
                                <div className='essential-result'>
                                    <div className='result-top'>
                                        <div className='result-top-left'>
                                            ...
                                            <div className='result-location'>{a.formatted_address}</div>
                                    ...
                                    <a className='result-contact' href={`tel:${a.formatted_phone_number}`}>
                                        <Phone />
